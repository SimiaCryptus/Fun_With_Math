async function createNam(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module['locateFile']) {
      return locateFile('nam_wasm.wasm');
    }
    return new URL('nam_wasm.wasm', import.meta.url).href;
  }
