...
const HERO_TYPES = [
  { id: "knight", name: "Knight", emoji: "🛡️", strong: "Might",
    trick: "Block an attack to protect a friend" },
  { id: "wizard", name: "Wizard", emoji: "🧙", strong: "Magic",
    trick: "Cast one \"Sparkle Spell\" per game" },
  { id: "scout",  name: "Scout",  emoji: "🏃", strong: "Speed",
    trick: "Move an extra space once per turn" },
  { id: "healer", name: "Healer", emoji: "💖", strong: "Heart",
...
const ENCOUNTERS = [
   { emoji: "👹", name: "Giggle Goblin", tn: 10, stats: ["Might", "Speed"],
     text: "It throws pillows! Dodge or knock it over." },
   { emoji: "🟤", name: "Grumpy Mud Puddle", tn: 5, stats: ["Speed", "Heart"],
     text: "It splishes and splashes. Hop across without getting squelched!" },
   { emoji: "🐉", name: "Ticklish Dragon", tn: 15, stats: ["Heart", "Magic"],
     text: "It guards the bridge — but it's VERY ticklish. Make it giggle!" },
   { emoji: "🧌", name: "Snoring Troll", tn: 10, stats: ["Speed", "Magic"],
     text: "ZZZ… sneak past without waking it!" },
   { emoji: "🌀", name: "Whirly Wind Puzzle", tn: 10, stats: ["Magic"],
     text: "Leaves spin in a riddle-shape. Solve the swirly pattern!" },
   { emoji: "🧱", name: "Wobbly Wall", tn: 5, stats: ["Might"],
...
const CHOICES = [
   { prompt: "A snoring troll blocks the path. What do you do?",
     options: ["Sneak past quietly", "Tickle it awake", "Build a pillow bridge over it"] },
   { prompt: "You find two glowing doors. Which one?",
     options: ["The sparkly blue door", "The giggling green door", "Peek through the keyhole first"] },
   { prompt: "A treasure chest hums a little tune. What now?",
     options: ["Open it carefully", "Knock politely first", "Ask the Wizard to check for sparkles"] },
   { prompt: "The river is too wide to jump. How do you cross?",
     options: ["Hop the lily pads", "Float across on a big leaf", "Ask a friendly turtle for a ride"] },
];
