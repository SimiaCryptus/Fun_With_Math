...
export const FireEvacuation = {
  ...
  description:
    'A solvent fire has started in the chemistry lab and the lab door was left open. Get at least 75% of the building out before responders arrive, with no more than two people incapacitated. Closing doors behind you buys turns.',
  mode: 'EVACUATE',
  seed: 4101,
  ...
  agents: [
    // Lab — closest to the fire
    {
      ...
      traits: { fear: 0.8, greed: 0.2, trust: 0.4, rage: 0.1, cohesion: 0.3 },
    },
    {
      id: 'marcus',
      name: 'Marcus',
      ...
      traits: { fear: 0.5, greed: 0.2, trust: 0.6, rage: 0.2, cohesion: 0.6 },
    },
    // Classroom A
    {
      id: 'okafor',
      ...
      traits: { fear: 0.2, greed: 0.1, trust: 0.8, rage: 0.1, cohesion: 0.9 },
    },
    {
      id: 'devon',
      name: 'Devon',
      ...
      traits: { fear: 0.2, greed: 0.8, trust: 0.2, rage: 0.9, cohesion: 0.2 },
    },
    {
      id: 'sam',
      name: 'Sam',
      ...
      traits: { fear: 0.5, greed: 0.3, trust: 0.3, rage: 0.2, cohesion: 0.4 },
    },
    {
      id: 'lena',
      name: 'Lena',
      ...
      traits: { fear: 0.4, greed: 0.9, trust: 0.5, rage: 0.2, cohesion: 0.4 },
    },
    {
      id: 'theo',
      name: 'Theo',
      ...
      traits: { fear: 0.3, greed: 0.2, trust: 0.7, rage: 0.1, cohesion: 0.7 },
    },
    // Office
    {
      id: 'hale',
      ...
      traits: { fear: 0.3, greed: 0.2, trust: 0.7, rage: 0.2, cohesion: 0.8 },
    },
    // Art room
    {
      id: 'aisha',
      ...
      traits: { fear: 0.3, greed: 0.2, trust: 0.6, rage: 0.1, cohesion: 0.7 },
    },
    {
      id: 'ben',
      name: 'Ben',
      ...
      traits: { fear: 0.6, greed: 0.3, trust: 0.4, rage: 0.3, cohesion: 0.4 },
    },
    // Classroom B
    {
      id: 'chloe',
      ...
      traits: { fear: 0.3, greed: 0.3, trust: 0.6, rage: 0.2, cohesion: 0.6 },
    },
    {
      id: 'ravi',
      name: 'Ravi',
      ...
      traits: { fear: 0.3, greed: 0.4, trust: 0.3, rage: 0.5, cohesion: 0.3 },
    },
    // Storage
    {
      id: 'jordan',
      name: 'Jordan',
      role: 'BYSTANDER',
      position: { x: 23, y: 12, z: 0 },
      traits: { fear: 0.4, greed: 0.3, trust: 0.4, rage: 0.2, cohesion: 0.2 },
    },
  ],
  winConditions: [
  ...
  events: [{ turn: 5, type: 'ALARM', message: 'Smoke detector trips the building alarm' }],
};
