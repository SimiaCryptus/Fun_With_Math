...
export const EarthquakeTornado = {
  ...
  description:
    'A quake has cracked the building and a tornado warning follows. Aftershocks will collapse weakened floors and the stairwell; the storm will shatter every window. Move people to interior rooms away from glass — or downstairs and out — and keep casualties to two or fewer for 11 turns.',
  mode: 'SHELTER',
  seed: 9021,
  ...
  agents: [
    ...
    },
    {
      ...
      traits: { fear: 0.6, greed: 0.2, trust: 0.5, rage: 0.2, cohesion: 0.5 },
    },
    {
      id: 'ada',
      name: 'Ada',
    ...
    },
    {
      ...
      traits: { fear: 0.5, greed: 0.8, trust: 0.4, rage: 0.3, cohesion: 0.3 },
    },
    {
      id: 'grace',
      name: 'Grace',
      role: 'STUDENT',
      position: { x: 17, y: 9, z: 1 },
      traits: { fear: 0.7, greed: 0.2, trust: 0.4, rage: 0.2, cohesion: 0.4 },
    },
    // Ground floor
    {
      id: 'leo',
      ...
      traits: { fear: 0.4, greed: 0.3, trust: 0.5, rage: 0.2, cohesion: 0.6 },
    },
    {
      id: 'osei',
      name: 'Mr. Osei',
      role: 'TEACHER',
      position: { x: 13, y: 8, z: 0 },
      traits: { fear: 0.2, greed: 0.1, trust: 0.7, rage: 0.1, cohesion: 0.8 },
    },
    {
      id: 'yara',
      name: 'Yara',
      ...
      traits: { fear: 0.5, greed: 0.3, trust: 0.5, rage: 0.2, cohesion: 0.5 },
    },
    {
      id: 'sofia',
      name: 'Sofia',
      ...
      traits: { fear: 0.4, greed: 0.2, trust: 0.7, rage: 0.1, cohesion: 0.6 },
    },
  ],
  winConditions: [
  ...
  events: [
    { turn: 2, type: 'AFTERSHOCK', magnitude: 0.35, message: 'Aftershock — the building shudders' },
    {
      turn: 5,
      type: 'ALARM',
      message: 'Weather radio: TORNADO WARNING — interior rooms, away from windows',
    },
    { turn: 7, type: 'WIND_GUST', message: 'The tornado passes — every window shatters' },
    {
      ...
      type: 'AFTERSHOCK',
      magnitude: 0.5,
      message: 'Major aftershock — weakened structure collapses',
    },
  ],
};
