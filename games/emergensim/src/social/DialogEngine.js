export const PHRASES = {
  PANIC_FREEZE: [
    ...
    "We're trapped! The stairs are gone!",
    'Where do we go?! WHERE?!',
  ],
  BULLY_AGGRESSION: [
    'Move! Stop blocking the exit!',
    'Out of my way. Now.',
    "You're too slow — get lost.",
  ],
  LEADERSHIP_CALM: [
    "Stay low. I've got your back.",
    "Everyone with me. Walk, don't run.",
    'Doors closed behind us. Keep moving.',
  ],
  WARN_HAZARD: [
    "Smoke! It's coming from the lab!",
    'Fire — that way! Go the other way!',
    "Don't go down there, it's bad!",
  ],
  GREED_BELONGINGS: [
    'Wait, my bag is still in there!',
    "I'm not leaving without my phone.",
    'Just one second, my stuff—',
  ],
  ...
  RUMOR: [
    'I heard the exit is blocked!',
    'Someone said the whole wing is on fire!',
    "They said don't go that way!",
  ],
...
const TONE = {
  ...
  RUMOR: 'panic',
  RUMOR_THREAT: 'panic',
  BULLY_AGGRESSION: 'aggro',
  LEADERSHIP_CALM: 'calm',
  DRILL: 'calm',
  SHELTER: 'calm',
  FOLLOW: 'calm',
};
...
export class DialogEngine {
  ...
  utter(npc, key) {
    ...
    const entry = {
      turn: this.state.meta.turnNumber,
      npcId: npc.id,
      name: npc.name,
      key,
      text,
